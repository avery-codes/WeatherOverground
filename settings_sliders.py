...
'''
def rangeslider():
    # from docs https://github.com/harshvinay752/RangeSlider/blob/1a068138c63ca61ccc734e71c27201e7a851c65a/sample.ipynb
    ...
    temperature: 1st choice
    temp: acceptable choice
    humidity: 1st choice
    humidity: acceptable choice
    time window: 1st choice
    time window: 2nd choice/acceptable choice
